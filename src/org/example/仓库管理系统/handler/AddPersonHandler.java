...
import org.example.仓库管理系统.service.MainUserService;
import org.example.仓库管理系统.service.impl.AddUserImpl;
import org.example.仓库管理系统.view.File.AddPersonView;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (text.equals("添加")) {
            ...
            if(!check(date)){
                ...
                boolean yanzhengadd = mainUserService.yanzhengadd(userTotalDao);
                System.out.println(yanzhengadd+"yanzhengadd");
                if (yanzhengadd) {
