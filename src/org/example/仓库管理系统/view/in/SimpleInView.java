...
import org.example.仓库管理系统.handler.inHandler.TJHandler;
...
public class SimpleInView extends JFrame {
    ...
    public SimpleInView(LoginView loginView){
        super("简单物料入库");
        tjHandler= new TJHandler(this,loginView);
        ...
        TJBtn.addActionListener(tjHandler);
        resetBtn.addActionListener(tjHandler);
