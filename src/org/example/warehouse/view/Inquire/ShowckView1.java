...
import org.example.warehouse.handler.ckHandler.DeleteckHandler;
...
public class ShowckView1 extends JFrame {
    ...
    DeleteckHandler deleteckHandler;
    public String getTxt(){
       return Txt.getText();
    }
    public  ShowckView1(List<ckDao> list){
        super("查询");
        deleteckHandler=new DeleteckHandler(this);
        ...
        jPanel.add(Txt);
        jPanel.add(jButton);
        jButton.addActionListener(deleteckHandler);
