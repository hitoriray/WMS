...
import org.example.warehouse.handler.inHandler.SubmitInHandler;
...
public class SimpleInView extends JFrame {
    ...
    SubmitInHandler submitInHandler;

    public SimpleInView(LoginView loginView) {
        super("简单物料入库");
        submitInHandler = new SubmitInHandler(this, loginView);
        ...
        TJBtn.addActionListener(submitInHandler);
        resetBtn.addActionListener(submitInHandler);
